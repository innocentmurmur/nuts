...
PairedFACEdata <- data.frame(merge(FACEdataA,FACEdataE,by="pair"))


#now I want to calculate individual response ratios
PairedFACEdata$RRyield <-PairedFACEdata$Yield.y/PairedFACEdata$Yield.x
PairedFACEdata$RRZn <-PairedFACEdata$Zn.y/PairedFACEdata$Zn.x
PairedFACEdata$RRFe <-PairedFACEdata$Fe.y/PairedFACEdata$Fe.x
PairedFACEdata$RRN <-PairedFACEdata$N.y/PairedFACEdata$N.x
PairedFACEdata$RRP <-PairedFACEdata$P.y/PairedFACEdata$P.x
PairedFACEdata$RRK <-PairedFACEdata$K.y/PairedFACEdata$K.x
PairedFACEdata$RRS <-PairedFACEdata$S.y/PairedFACEdata$S.x
PairedFACEdata$RRB <-PairedFACEdata$B.y/PairedFACEdata$B.x
PairedFACEdata$RRCa <-PairedFACEdata$Ca.y/PairedFACEdata$Ca.x
PairedFACEdata$RRMg<-PairedFACEdata$Mg.y/PairedFACEdata$Mg.x
PairedFACEdata$RRMn<-PairedFACEdata$Mn.y/PairedFACEdata$Mn.x
PairedFACEdata$RRCu <-PairedFACEdata$Cu.y/PairedFACEdata$Cu.x
...
##Swap this over when you're really wanting that!!!!!
controlFACE<-PairedMeanFACEy
...
write.csv(controlFACEsummary, file="~/Rdata/nutrients/controlFACEsummary.csv")
