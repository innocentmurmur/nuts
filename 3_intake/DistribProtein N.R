...
FBS_Distribution_parameters$CO2_mean_lo_HHS <- log(SOFIGINIFBS$protein.co2.g_lo)- (FBS_Distribution_parameters$SD_HHS^2)/2
FBS_Distribution_parameters$CO2_mean_lo_SOFI <- log(SOFIGINIFBS$protein.co2.g_lo)- (FBS_Distribution_parameters$SD_SOFI^2)/2
FBS_Distribution_parameters$CO2_mean_med_HHS <- log(SOFIGINIFBS$protein.co2.g_med)- (FBS_Distribution_parameters$SD_HHS^2)/2
FBS_Distribution_parameters$CO2_mean_med_SOFI <-log(SOFIGINIFBS$protein.co2.g_med)- (FBS_Distribution_parameters$SD_SOFI^2)/2
FBS_Distribution_parameters$CO2_mean_hi_HHS <- log(SOFIGINIFBS$protein.co2.g_hi)- (FBS_Distribution_parameters$SD_HHS^2)/2
FBS_Distribution_parameters$CO2_mean_hi_SOFI <- log(SOFIGINIFBS$protein.co2.g_hi)- (FBS_Distribution_parameters$SD_SOFI^2)/2
